...
# ============================================================
# #12 LTX-2.3 + 10Eros v1.5 + Licon MSR V2
...
LOG="${LOGDIR}/setup_12_ltx23_10eros_msr_${STAMP}.log"

mkdir -p "$ROOT" "$LOGDIR"
exec > >(tee -a "$LOG") 2>&1

echo "============================================================"
echo "[#12] LTX-2.3 + 10Eros v1.5 + Licon MSR V2"
echo "Time: $(date -Is)"
echo "Root: $ROOT"
echo "ComfyUI: $COMFY"
echo "Port: $PORT"
...
readme = """#12 LTX-2.3 + 10Eros v1.5 + Licon MSR V2
...
SERVER_LOG="${LOGDIR}/comfy_12_ltx23_10eros_msr_${STAMP}.log"
...
echo
echo "============================================================"
echo "[SUCCESS] #12 environment is up."
echo
