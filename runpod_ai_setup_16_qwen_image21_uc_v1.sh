...
# Port: 8188
#
# Sources intentionally pinned by repository/file:
# - ComfyUI: comfyanonymous/ComfyUI
# - GGUF loader: leejet/ComfyUI-GGUF
# - UC model: abenzerps/Qwen-Image-2.1-Uncensored-GGUF
# - Text encoder / VAE: Comfy-Org/Qwen-Image-2.1
# - Workflows: Comfy-Org/workflow_templates
# ============================================================
