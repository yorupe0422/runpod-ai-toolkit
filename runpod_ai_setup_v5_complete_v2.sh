...
URL_PINK_MODEL="https://huggingface.co/SexGod1979/PinkCherry_MiniMax-H3/resolve/main/alpha-0.5-testing/$PINK_MODEL"
...
URL_TURBO_LORA="https://huggingface.co/drbaph/MiniMax-H3-Turbo-Lora-ComfyUI/resolve/main/$TURBO_LORA"
...
cleanup_on_error() {
  ...
  if [[ $rc -ne 0 ]]; then
    red ""
    red "SETUP #5 COMPLETE v2 FAILED"
...
echo
echo "================================================================="
echo " SETUP #5 COMPLETE v2 — MiniMax H3 / PinkCherry"
echo "================================================================="
...
verified_download() {
  ...
  # If file exists but is unverified, hash it before redownloading.
  if [[ -f "$dest" ]]; then
...
verified_download "$URL_BASE_MODEL" "$COMFY/models/diffusion_models/$BASE_MODEL" "$SHA_BASE_MODEL"
verified_download "$URL_TEXT_MODEL" "$COMFY/models/text_encoders/$TEXT_MODEL" "$SHA_TEXT_MODEL"
verified_download "$URL_VIDEO_VAE" "$COMFY/models/vae/$VIDEO_VAE" "$SHA_VIDEO_VAE"
verified_download "$URL_AUDIO_VAE" "$COMFY/models/vae/$AUDIO_VAE" "$SHA_AUDIO_VAE"
...
verified_download "$URL_PINK_MODEL" "$COMFY/models/diffusion_models/$PINK_MODEL" "$SHA_PINK_MODEL"
verified_download "$URL_TURBO_LORA" "$COMFY/models/loras/$TURBO_LORA" "$SHA_TURBO_LORA"
...
PINK_URL = f"https://huggingface.co/SexGod1979/PinkCherry_MiniMax-H3/resolve/main/alpha-0.5-testing/{PINK_MODEL}"
...
echo
echo "================================================================="
green " SETUP #5 COMPLETE v2 — GENERATION READY"
echo "================================================================="
echo "ComfyUI       : $COMFY"
